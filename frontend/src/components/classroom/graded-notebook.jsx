...
function PenMark({ kind }) {
  return (
    <svg viewBox="0 0 32 32" className="rb-pen-mark" aria-hidden="true">
      {PATHS[kind].map((d) => (
...
function PenCircle() {
  return (
    <svg viewBox="0 0 100 60" preserveAspectRatio="none" className="rb-pen-circle" aria-hidden="true">
      <path
...
function PenUnderline() {
  return (
    <svg viewBox="0 0 200 12" preserveAspectRatio="none" className="rb-pen-underline" aria-hidden="true">
